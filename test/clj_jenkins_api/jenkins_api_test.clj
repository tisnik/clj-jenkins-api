...
(deftest test-update-jenkins-url-existence
  ...
  (testing
    "if the clj-jenkins-api.jenkins-api/update-jenkins-url definition exists."
...
(deftest test-read-list-of-all-jobs-existence
  ...
  (testing
    "if the clj-jenkins-api.jenkins-api/read-list-of-all-jobs definition exists."
...
(deftest test-read-job-results-existence
  ...
  (testing
    "if the clj-jenkins-api.jenkins-api/read-job-results definition exists."
...
(deftest test-read-file-from-artifact-existence
  ...
  (testing
    "if the clj-jenkins-api.jenkins-api/read-file-from-artifact definition exists."
...
(deftest test-ok-response-structure-existence
  ...
  (testing
    "if the clj-jenkins-api.jenkins-api/ok-response-structure definition exists."
...
(deftest test-error-response-structure-existence
  ...
  (testing
    "if the clj-jenkins-api.jenkins-api/error-response-structure definition exists."
...
(deftest test-job-related-command-existence
  ...
  (testing
    "if the clj-jenkins-api.jenkins-api/job-related-command definition exists."
...
(deftest test-replace-placeholder-existence
  ...
  (testing
    "if the clj-jenkins-api.jenkins-api/replace-placeholder definition exists."
...
(deftest test-update-template-existence
  ...
  (testing
    "if the clj-jenkins-api.jenkins-api/update-template definition exists."
...
(deftest test-send-configuration-xml-to-jenkins-existence
  ...
  (testing
    "if the clj-jenkins-api.jenkins-api/send-configuration-xml-to-jenkins definition exists."
    (is (callable? 'clj-jenkins-api.jenkins-api/update-template))))
...
(deftest test-job-name->url-1
  ...
  (testing
    "the clj-jenkins-api.jenkins-api/job-name->url"
    (are [x y] (= x y)
         "job/"                  (job-name->url "" "")
         " job/"                 (job-name->url " " "")
...
(deftest test-update-jenkins-url-1
  ...
  (testing
    "the clj-jenkins-api.jenkins-api/update-jenkins-url"
    (are [x y] (= x y)
...
(deftest test-update-jenkins-url-NPE
  ...
  (testing "the clj-jenkins-api.jenkins-api/update-jenkins-url"
           (is (thrown? NullPointerException
                        (update-jenkins-url nil "name:password")))))
...
(deftest test-get-command
  ...
  (testing
    "the clj-jenkins-api.jenkins-api/get-command"
  ...
  (testing "the clj-jenkins-api.jenkins-api/post-command"
           (with-redefs [http-client/post (fn [url mapa] {:body url})]
             (are [x y] (= x y)
                  ...
                  (post-command "http://jenkins.url.org/" "user:password"
                                "job-name" "")))))

(deftest test-list-of-all-jobs
  "Check the clj-jenkins-api.jenkins-api/list-of-all-jobs"
  (testing
    "the clj-jenkins-api.jenkins-api/list-of-all-jobs"
